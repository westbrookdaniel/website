  ...
  <body hx-boost="true">
    ...
    <main class="pt-24 pb-32 relative max-w-[90ch] mx-auto flex-1 w-full">
      <div class="side-p mb-48">
      	<h1 class="min-h-[32px] font-heading text-balance text-2xl mb-4">${postData.data.title}</h1>
        <p class="text-zinc-500 text-balance max-w-[60ch] mb-1">${postData.data.description}</p>
      ...
      <div class="side-p flex justify-start mt-20">
        <a class="button active" href="/blog">
          ${LeftIcon()}
          All Posts
        </a>
      </div>
